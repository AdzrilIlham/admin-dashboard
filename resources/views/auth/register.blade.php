    ...
    <div class="register-container">
        <div class="left-side">
            <div class="illustration">
                ...
                <h2>Join Us Today!</h2>
                <p>Create your account and start managing your application with our powerful admin dashboard</p>
            </div>
        </div>
        ...
        <div class="right-side">
            <div class="register-form-wrapper">
                ...
                <div class="social-login">
                    ...
                    <button class="social-btn" onclick="alert('Facebook signup integration needed')">
